...
12. Open a terminal, browse to a convenient location for your project, and type `git clone https://github.com/sanjayakumarsahoo/project-documentation-jekyll`, replacing the `https://github.com/sanjayakumarsahoo/project-documentation-jekyll` with your repository's https clone URL that you copied.
...
14. Open the \_config.yml file and add the following:
   ...
   ```
   url: project-documentation-jekyll.github.io
   baseurl: /sanjayakumarsahoo
   ```
...
Github Pages will now automatically build your site. Wait a minute or two, and then visit sanjayakumarsahoo.github.io/project-d, replacing this path with your github account and branch.
